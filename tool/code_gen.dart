...
class UnifiedGenerator {
  ...
  static Future<void> showMainMenu() async {
    ...
    print('7️⃣  Update Entity & Mapper from Model (Sync)');
    print('');
    print('0️⃣  Exit');
    print('');

    stdout.write('Select option (0-7): ');
    ...
    switch (choice) {
      ...
      case '6':
        ...
        break;
      case '7':
        await handleSyncEntityAndMapper();
        break;
      case '0':
        print('👋 Goodbye!');
        return;
  ...
  /// Handle Generate Entity with folder selection
  ...
  /// Handle Generate Mapper with folder selection
  ...
  /// NEW: Handle Sync Entity and Mapper from Model
  static Future<void> handleSyncEntityAndMapper() async {
    print('');
    print('🔄 SYNC ENTITY & MAPPER FROM MODEL');
    print('─────────────────────────────────────');
    print('This will update existing Entity and Mapper based on Model changes');
    print('');
    ...
    stdout.write('Enter existing entity path: ');
    final entityPath = stdin.readLineSync();
    if (entityPath == null || entityPath.isEmpty) {
      print('❌ Entity path is required');
      return;
    ...
    if (!await File(entityPath).exists()) {
      print('❌ Entity file not found: $entityPath');
      print('💡 Tip: Use option 1 to generate entity first');
      return;
    }

    stdout.write('Enter existing mapper path: ');
    final mapperPath = stdin.readLineSync();
    if (mapperPath == null || mapperPath.isEmpty) {
      print('❌ Mapper path is required');
      return;
    }

    if (!await File(mapperPath).exists()) {
      print('❌ Mapper file not found: $mapperPath');
      print('💡 Tip: Use option 2 to generate mapper first');
      return;
    }
    ...
    await syncEntityAndMapper(modelPath, entityPath, mapperPath);
  }
  ...
  static Future<String?> _selectOrCreateFolder(
    ...
    print('Available folders in $basePath:');
    print('');
    ...
    stdout.write('Select option (1-${folders.length + 1}): ');
    final choice = stdin.readLineSync();
    ...
    if (selection == folders.length + 1) {
      ...
      if (await Directory(newFolderPath).exists()) {
        ...
        print('💡 Please select from existing folders or choose a different name');
        return null;
      }
  ...
  static Future<void> generateEntityFromModel(
    ...
    if (customEntityPath != null) {
      entityPath = '$customEntityPath/${analysis.featureName}_entity.dart';
    } else {
    ...
    if (await File(entityPath).exists()) {
      ...
      print('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      print('📄 File: $entityPath');
      print('');
      print('This file already exists. Please choose:');
      print('  1. Delete the existing file manually');
      print('  2. Use option 7 (Sync) to update it');
      print('  3. Choose a different folder');
      print('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      print('');
      return;
    }

    // Generate entity content (without copyWith and toString)
  ...
  /// NEW: Sync Entity and Mapper from Model
  static Future<void> syncEntityAndMapper(
    ...
    print('');
    print('🔄 Syncing Entity and Mapper from Model...');
    print('');
    ...
    print('   - Class: ${modelAnalysis.className}');
    print('   - Properties: ${modelAnalysis.properties.length}');
    print('');

    // Generate updated entity
    final entityContent = _generateEntityContent(modelAnalysis);
    await File(entityPath).writeAsString(entityContent);
    print('✅ Entity updated: $entityPath');
    ...
    print('✅ Mapper updated: $mapperPath');

    print('');
    print('🎉 Sync completed successfully!');
    print('   New fields have been automatically added');
    print('   Old fields have been preserved');
  }
  ...
  static Future<void> generateMapperFromFiles(
    ...
    if (customMapperPath != null) {
      mapperPath = '$customMapperPath/${modelAnalysis.featureName}_mapper.dart';
    } else {
